...
Define tab completion: the `spinloop completion <shell>` scripts and the hidden
`spinloop __complete` protocol they call, which is the single source of truth for
