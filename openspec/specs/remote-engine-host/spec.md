...
The instance-side half of the cloud deployment: spinloop installed during boot
...
metrics by shelling commands over SSM, duplicating in TypeScript what spinloop
