...
const DEFAULTS = {
  ...
  // load — a few minutes against the provisioned root volume), or the idle
  // check stops the instance mid-load (the metrics scrape fails while the
  // server is still loading, which reads as "idle").
